...
The next line has n integers x\_1,x\_2,…,x\_n: the contents of the array. Value 0 denotes an unknown value.
...
---
**Source:** [https://cses.fi/problemset/task/1746](https://cses.fi/problemset/task/1746)