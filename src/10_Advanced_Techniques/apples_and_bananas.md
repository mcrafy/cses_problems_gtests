...
There are n apples and m bananas, and each of them has an integer weight between 1 \ldots k. Your task is to calculate, for each weight w between 2 … 2k, the number of ways we can choose an apple and a banana whose combined weight is w.
...
---
**Source:** [https://cses.fi/problemset/task/2111](https://cses.fi/problemset/task/2111)