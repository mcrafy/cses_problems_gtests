...
Your task is to count the number of Eulerian subgraphs modulo 10<sup>9</sup>+7.
...
Print the number of Eulerian subgraphs modulo 10<sup>9</sup>+7.
...
---
**Source:** [https://cses.fi/problemset/task/2078](https://cses.fi/problemset/task/2078)